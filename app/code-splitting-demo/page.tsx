...
import { BiasCardDetailedLoader, BiasCardCompactLoader, ProgressStatsLoader, RecommendationCardLoader } from "@/components/loading-fallback"
...
export default function CodeSplittingDemoPage() {
  ...
  const mockBias = {
    ...
    summary: "The tendency to search for, interpret, and recall information that confirms our preexisting beliefs.",
        ...
        <div className="space-y-6">
          ...
          <Card className="glass p-6">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h2 className="text-xl font-semibold mb-2">Example 1: Component with Custom Loader</h2>
  ...
  ssr: true
          ...
          <Card className="glass p-6">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h2 className="text-xl font-semibold mb-2">Example 2: Client-Side Only Component</h2>
                <p className="text-sm text-muted-foreground">
  ...
  ssr: false // Disable server-side rendering
          ...
          <Card className="glass p-6">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h2 className="text-xl font-semibold mb-2">Example 3: On-Demand Loading</h2>
                <p className="text-sm text-muted-foreground">
  ...
  loading: () => <ProgressStatsLoader />
          ...
          <Card className="glass p-6">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h2 className="text-xl font-semibold mb-2">Example 4: Conditional Rendering</h2>
                <p className="text-sm text-muted-foreground">
  ...
  <DynamicRecommendationCard bias={bias} reason={reason} />
          ...
          <Card className="glass p-6">
            ...
            <div className="space-y-4 text-sm">
              <div>
                <h3 className="font-semibold mb-2">1. Create Dynamic Wrappers</h3>
...
export const DynamicBiasCard = dynamic(
  ...
  { loading: () => <BiasCardLoader />, ssr: true }
              ...
              <div>
                <h3 className="font-semibold mb-2">2. Create Loading Fallbacks</h3>
                <p className="text-muted-foreground mb-2">
  ...
  return (
    <div className="glass rounded-2xl p-6 space-y-3">
      ...
      <Skeleton className="h-16 w-full" />
              ...
              <div>
                <h3 className="font-semibold mb-2">3. Use Dynamic Imports in Pages</h3>
                <p className="text-muted-foreground mb-2">
...
import { DynamicBiasCard } from "@/components/dynamic-bias-card"`}
              ...
              <div>
                <h3 className="font-semibold mb-2">4. Configure Next.js</h3>
                <p className="text-muted-foreground mb-2">
...
export default {
  webpack: (config) => {
    ...
    return config
          ...
          <Card className="glass p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                ...
                <Badge variant="secondary" className="text-green-600">~30-40%</Badge>
              </div>
              <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                <span>Time to Interactive (TTI) Improvement</span>
                <Badge variant="secondary" className="text-green-600">~25-35%</Badge>
              </div>
              <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
                <span>First Contentful Paint (FCP)</span>
                <Badge variant="secondary" className="text-green-600">~20-30% faster</Badge>
              </div>
              <p className="text-muted-foreground text-xs mt-4">
                * Actual improvements vary based on network conditions and device performance.
                These metrics are typical ranges observed in production environments.
              </p>
            </div>
          </Card>
          ...
          {/* Applied Across App */}
          <Card className="glass p-6">
            <h2 className="text-xl font-semibold mb-4">Code Splitting Across DailyBias</h2>
